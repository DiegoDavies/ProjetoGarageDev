...
Ext.Loader.addClassPathMappings({
  ...
  "ProjetoGarage": "../../../../../app",
  "ProjetoGarage.store.etnia.Store": "../../../../../app/store/etnia/store.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "ProjetoGarage.model.combos.EstadoCivil": [],
  ...
  "ProjetoGarage.model.contaReceber.Model": [],
  "ProjetoGarage.model.contaReceber.Ocorrencia": [],
  "ProjetoGarage.model.contaReceber.Recebimento": [],
  ...
  "ProjetoGarage.store.combos.EstadoCivil": [],
  ...
  "ProjetoGarage.store.contaReceber.Ocorrencia": [],
  "ProjetoGarage.store.contaReceber.Recebimento": [],
  "ProjetoGarage.store.contaReceber.Store": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "ProjetoGarage.view.contaPagar.Grid": [
    "widget.contaPagar-grid"
  ],
  "ProjetoGarage.view.contaPagar.GridOcorrencia": [
    "widget.contaPagar-gridOcorrencia"
  ],
  "ProjetoGarage.view.contaPagar.GridPagamento": [
    "widget.contaPagar-gridPagamento"
  ],
  "ProjetoGarage.view.contaPagar.Panel": [
    "widget.contaPagar-panel"
  ],
  "ProjetoGarage.view.contaPagar.TabPanelFilho": [
    "widget.contaPagar-tabPanel"
  ],
  "ProjetoGarage.view.contaPagar.Tela": [
    "widget.contaPagar-tela"
  ],
  "ProjetoGarage.view.contaReceber.Form": [
    "widget.contaReceber-form"
  ],
  "ProjetoGarage.view.contaReceber.Grid": [
    "widget.contaReceber-grid"
  ],
  "ProjetoGarage.view.contaReceber.GridOcorrencia": [
    "widget.contaReceber-gridOcorrencia"
  ],
  "ProjetoGarage.view.contaReceber.GridRecebimento": [
    "widget.contaReceber-gridRecebimento"
  ],
  "ProjetoGarage.view.contaReceber.Panel": [
    "widget.contaReceber-panel"
  ],
  "ProjetoGarage.view.contaReceber.TabPanelFilho": [
    "widget.contaReceber-tabPanel"
  ],
  "ProjetoGarage.view.contaReceber.Tela": [
  ...
  "ProjetoGarage.view.funcionario.FormDependente": [
    "widget.funcionario-formDependente"
  ],
  "ProjetoGarage.view.funcionario.FormHistoricoOcupacional": [
    "widget.funcionario-formHistoricoOcupacional"
  ],
  "ProjetoGarage.view.funcionario.FormPagamento": [
    "widget.funcionario-formPagamento"
  ],
  "ProjetoGarage.view.funcionario.Grid": [
    "widget.funcionario-grid"
  ],
  "ProjetoGarage.view.funcionario.GridDependente": [
    "widget.funcionario-gridDependente"
  ],
  "ProjetoGarage.view.funcionario.GridHistorico": [
    "widget.funcionario-gridHistorico"
  ],
  "ProjetoGarage.view.funcionario.GridHistoricoOcupacional": [
    "widget.funcionario-gridHistoricoOcupacional"
  ],
  "ProjetoGarage.view.funcionario.GridPagamento": [
    "widget.funcionario-gridPagamento"
  ],
  "ProjetoGarage.view.funcionario.Panel": [
    "widget.funcionario-panel"
  ],
  "ProjetoGarage.view.funcionario.TabPanelFilho": [
    "widget.funcionario-tabPanel"
  ],
  "ProjetoGarage.view.funcionario.Tela": [
    "widget.funcionario-tela"
  ],
  "ProjetoGarage.view.funcionario.WindowDependente": [
    "widget.funcionario-windowDependente"
  ],
  "ProjetoGarage.view.funcionario.WindowHistoricoOcupacional": [
    "widget.funcionario-windowHistoricoOcupacional"
  ],
  "ProjetoGarage.view.funcionario.WindowPagamento": [
    "widget.funcionario-windowPagamento"
  ],
  "ProjetoGarage.view.login.Login": [
  ...
  "ProjetoGarage.view.orcamento.Grid": [
    "widget.orcamento-grid"
  ],
  "ProjetoGarage.view.orcamento.GridCustos": [
    "widget.orcamento-gridCustos"
  ],
  "ProjetoGarage.view.orcamento.GridOcorrencia": [
    "widget.orcamento-gridOcorrencia"
  ],
  "ProjetoGarage.view.orcamento.GridProduto": [
    "widget.orcamento-gridProduto"
  ],
  "ProjetoGarage.view.orcamento.GridVeiculo": [
    "widget.orcamento-gridVeiculo"
  ],
  "ProjetoGarage.view.orcamento.Panel": [
    "widget.orcamento-panel"
  ],
  "ProjetoGarage.view.orcamento.TabPanelFilho": [
    "widget.orcamento-tabPanel"
  ],
  "ProjetoGarage.view.orcamento.Tela": [
  ...
  "ProjetoGarage.view.servico.GridCustos": [
    "widget.servico-gridCustos"
  ],
  "ProjetoGarage.view.servico.GridOcorrencia": [
    "widget.servico-gridOcorrencia"
  ],
  "ProjetoGarage.view.servico.GridProduto": [
    "widget.servico-gridProduto"
  ],
  "ProjetoGarage.view.servico.GridVeiculo": [
    "widget.servico-gridVeiculo"
  ],
  "ProjetoGarage.view.servico.Panel": [
    "widget.servico-panel"
  ],
  "ProjetoGarage.view.servico.TabPanelFilho": [
    "widget.servico-tabPanel"
  ],
  "ProjetoGarage.view.servico.Tela": [
    "widget.servico-tela"
  ],
...
Ext.Boot.loadSync([
    "/C:/Users/diego/bin/Sencha/Cmd/6.5.3.6/ant/build/slicer/render.js",
