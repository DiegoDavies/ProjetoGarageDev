Ext.define('ProjetoGarage.view.grupoCompra.Window', {
    extend: 'Ext.window.Window',
    xtype: 'grupoCompra-window',
    requires: [
        'ProjetoGarage.view.grupoCompra.Form'
    ],
    layout: 'fit',
    varWidth: 0,
    modal: true,
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            if (me.extraData.formType === 'Cadastrar') {
                var model = Ext.create('ProjetoGarage.model.grupoCompra.Model');
