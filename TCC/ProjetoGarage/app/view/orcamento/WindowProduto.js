Ext.define('ProjetoGarage.view.orcamento.WindowProduto', {
    extend: 'Ext.window.Window',
    xtype: 'orcamento-windowProduto',
    requires: [
        'ProjetoGarage.view.orcamento.FormProduto'
    ],
    layout: 'fit',
    modal: true,
    ...
    addReferences: function () {
        ...
        me.form = me.down('orcamento-formProduto');
        //
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.extraData.formType === 'Cadastrar') {
            var model = Ext.create('ProjetoGarage.model.orcamento.Produto');
