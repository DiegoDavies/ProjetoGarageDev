Ext.define('ProjetoGarage.view.modeloProduto.Window', {
    extend: 'Ext.window.Window',
    xtype: 'modeloProduto-window',
    requires: [
        'ProjetoGarage.view.modeloProduto.Form'
    ],
    layout: 'fit',
    varWidth: 0,
    modal: true,
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            if (me.extraData.formType === 'Cadastrar') {
                var model = Ext.create('ProjetoGarage.model.modeloProduto.Model');
