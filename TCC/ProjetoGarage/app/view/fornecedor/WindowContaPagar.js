Ext.define('ProjetoGarage.view.fornecedor.WindowContaPagar', {
    extend: 'Ext.window.Window',
    xtype: 'fornecedor-windowContaPagar',
    requires: [
        'ProjetoGarage.view.fornecedor.FormContaPagar'
    ],
    layout: 'fit',
    modal: true,
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            bodyPadding: 10,
            items: [{
                xtype: 'fornecedor-formContaPagar',
                window: me
            }],
            bbar: ['->', {
                xtype: 'button',
    ...
    addReferences: function () {
        ...
        me.form = me.down('fornecedor-formContaPagar');
        //
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            var model = Ext.create('ProjetoGarage.model.fornecedor.ContaPagar');
