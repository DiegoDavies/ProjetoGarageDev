Ext.define('ProjetoGarage.view.servico.WindowVeiculo', {
    extend: 'Ext.window.Window',
    xtype: 'servico-windowVeiculo',
    requires: [
        'ProjetoGarage.view.servico.FormVeiculo'
    ],
    layout: 'fit',
    modal: true,
    ...
    addReferences: function () {
        ...
        me.form = me.down('servico-formVeiculo');
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.extraData.formType === 'Cadastrar') {
            var model = Ext.create('ProjetoGarage.model.servico.Veiculo');
