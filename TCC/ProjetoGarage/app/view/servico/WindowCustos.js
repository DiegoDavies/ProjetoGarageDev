Ext.define('ProjetoGarage.view.servico.WindowCustos', {
    extend: 'Ext.window.Window',
    xtype: 'servico-windowCustos',
    requires: [
        'ProjetoGarage.view.servico.FormCustos'
    ],
    layout: 'fit',
    modal: true,
    ...
    addReferences: function () {
        ...
        me.form = me.down('servico-formCustos');
        //
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.extraData.formType === 'Cadastrar') {
            var model = Ext.create('ProjetoGarage.model.servico.Custos');
