Ext.define('ProjetoGarage.view.contaReceber.WindowRecebimento', {
    extend: 'Ext.window.Window',
    xtype: 'contaReceber-windowRecebimento',
    requires: [
        'ProjetoGarage.view.contaReceber.FormRecebimento'
    ],
    layout: 'fit',
    modal: true,
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            bodyPadding: 10,
            items: [{
                xtype: 'contaReceber-formRecebimento',
                window: me
            }],
            bbar: ['->', {
                xtype: 'button',
    ...
    addReferences: function () {
        ...
        me.form = me.down('contaReceber-formRecebimento');
        //
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            if (me.extraData.formType === 'Cadastrar') {
                var model = Ext.create('ProjetoGarage.model.contaReceber.Recebimento');
