Ext.define('ProjetoGarage.view.unidadeMedida.Window', {
    extend: 'Ext.window.Window',
    xtype: 'unidadeMedida-window',
    requires: [
        'ProjetoGarage.view.unidadeMedida.Form'
    ],
    layout: 'fit',
    varWidth: 0,
    modal: true,
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            if (me.extraData.formType === 'Cadastrar') {
                var model = Ext.create('ProjetoGarage.model.unidadeMedida.Model');
