Ext.define('ProjetoGarage.view.telaPrincipal.WindowSuporte', {
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            storeSuporte: Ext.create('ProjetoGarage.store.telaPrincipal.Suporte'),
            items: [{
                xtype: 'htmleditor',
                itemId: 'txtMensagem',
                width: '100%',
            ...
            Ext.Msg.show({
                ...
                fn: function (btn) {
                    if (btn === 'yes') {
                        ...
                        var model = Ext.create('ProjetoGarage.model.telaPrincipal.Suporte');
                        model.set('Mensagem', me.txtMensagem.getValue());
                        me.storeSuporte.add(model);

                        me.storeSuporte.sync({
