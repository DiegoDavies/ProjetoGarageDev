Ext.define('ProjetoGarage.view.cliente.WindowOrcamento', {
    extend: 'Ext.window.Window',
    xtype: 'cliente-windowOrcamento',
    requires: [
        'ProjetoGarage.view.cliente.FormOrcamento'
    ],
    layout: 'fit',
    modal: true,
    ...
    addReferences: function () {
        ...
        me.form = me.down('cliente-formOrcamento');
        //
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            var model = Ext.create('ProjetoGarage.model.cliente.Orcamento');
