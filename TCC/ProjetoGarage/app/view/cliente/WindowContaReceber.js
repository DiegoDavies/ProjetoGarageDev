Ext.define('ProjetoGarage.view.cliente.WindowContaReceber', {
    extend: 'Ext.window.Window',
    xtype: 'cliente-windowContaReceber',
    requires: [
        'ProjetoGarage.view.cliente.FormContaReceber'
    ],
    layout: 'fit',
    modal: true,
    ...
    addReferences: function () {
        ...
        me.form = me.down('cliente-formContaReceber');
        //
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            var model = Ext.create('ProjetoGarage.model.cliente.ContaReceber');
