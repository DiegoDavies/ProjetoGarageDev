Ext.define('ProjetoGarage.view.marcaProduto.Window', {
    extend: 'Ext.window.Window',
    xtype: 'marcaProduto-window',
    requires: [
        'ProjetoGarage.view.marcaProduto.Form'
    ],
    layout: 'fit',
    varWidth: 0,
    modal: true,
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            if (me.extraData.formType === 'Cadastrar') {
                var model = Ext.create('ProjetoGarage.model.marcaProduto.Model');
