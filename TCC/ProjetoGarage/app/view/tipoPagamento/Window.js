Ext.define('ProjetoGarage.view.tipoPagamento.Window', {
    extend: 'Ext.window.Window',
    xtype: 'tipoPagamento-window',
    requires: [
        'ProjetoGarage.view.tipoPagamento.Form'
    ],
    layout: 'fit',
    varWidth: 0,
    modal: true,
    ...
    onBtnSalvarClick: function () {
        ...
        if (me.form.isValid()) {
            if (me.extraData.formType === 'Cadastrar') {
                var model = Ext.create('ProjetoGarage.model.tipoPagamento.Model');
